...
')
     ...
     */ 
        ...
        {
                        /** @var \HnhDigital\PhpNumberConverter\NumberConverter $instance */
                        return $instance->convert($number, $type);
        }
                    /**
        ...
        {
                        /** @var \HnhDigital\PhpNumberConverter\NumberConverter $instance */
                        return $instance->numberOrdinal($number);
        }
                    /**
         * Alias to convertToOrdinal.
         *
        ...
        {
                        /** @var \HnhDigital\PhpNumberConverter\NumberConverter $instance */
                        return $instance->ordinal($number);
        }
                    /**
         * Alias to convertToOrdinal.
         *
         ...
         * @static 
         */ 
        public static function wordOrdinal($number)
        {
                        /** @var \HnhDigital\PhpNumberConverter\NumberConverter $instance */
                        return $instance->wordOrdinal($number);
        }
                    /**
...
namespace  { 
            ...
            class NumConvert extends \HnhDigital\LaravelNumberConverter\Facade {}
